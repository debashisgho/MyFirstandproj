...
public class MainActivity extends ActionBarActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.ListenerButton) {
			Log.d(APP_LOG_TAG,
					"Button Listener was clicked and method was invoked via onClick listener");
		}
	...
	public void sendEmail(View v) {
		...
		if (v.getId() == R.id.sendEmailButton) {
			...
			intent.putExtra(Intent.EXTRA_TEXT,
					"Hello ! how are you doing. This is a test email from the app");
	...
	public void sendImage(View v) {
		...
		if (v.getId() == R.id.sendImage) {
			...
			intent.setAction(android.content.Intent.ACTION_SEND);
			Uri uri = Uri
					.parse("android.resource://com.example.myfirstandproj/drawable/"
							+ R.drawable.background);
			intent.setType("image/*");
			intent.putExtra(Intent.EXTRA_STREAM, uri);
			intent.putExtra(Intent.EXTRA_TEXT,
					"Hello ! Here is the image from the android app");
	...
	public void sendMultipleImages(View v) {
		...
		if (v.getId() == R.id.SendImages) {
			...
			// for some reason directory.list() method is not working, so
			// working with the file name itself.
			...
			intent.putExtra(Intent.EXTRA_TEXT,
					"Hello ! Here are the images from the android app");
			Intent chooser = Intent.createChooser(intent, "Send Image using");
			startActivity(chooser);
	...
	public void showToast(View v) {
		Toast toast = Toast.makeText(this, "Hello ! How are you ?",
				Toast.LENGTH_LONG);
	...
	public void showCustomToast(View v) {
		...
		View toastView = inflater.inflate(R.layout.custom_toast,
				(ViewGroup) findViewById(R.id.custom_toast_root_id));
	...
	public void goToAdapterActivity(View v) {
